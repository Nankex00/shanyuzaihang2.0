...
//                //对微信小程序登录接口，检查接口放行
//                .antMatchers("/wxSignatureCheck","/wechatLogin","/wechatGetUserInfo").permitAll()
////                .antMatchers("/miniprogram/**").permitAll()
//                //放行临时上传
//                .antMatchers("/resource/tempUpload").permitAll()
//                //放行openId获取token
//                .antMatchers("/wechatGetUserInfoByOpenId").permitAll()
//                //放行手机号解密
//                .antMatchers("/wechatGetPhoneNumber").permitAll()
//                //放行websocket
//                .antMatchers("/ws/ep/**").permitAll()
                // 静态资源，可匿名访问
                .antMatchers(HttpMethod.GET, "/", "/*.html", "/**/*.html","/img/**", "/**/*.css", "/**/*.js", "/profile/**").permitAll()
